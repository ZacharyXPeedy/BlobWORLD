...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziBlob", src: "./img/bonzi/blob.png" },
        ...
        { id: "bonziDress", src: "./img/bonzi/cyan.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("000", () => {
            ...
            var spookynames = ["BlobSATAN", "BlobDEATH", "The Devil", "The Soul", "Demon", "Hellfire", "Crylast"];
...
var _createClass = (function () {
                    ...
                    build: function (a, b) {
                        ...
                        let menu = {
                            items: {
                                ...
                                mute: {
                                    name: function () {
                                        return d.mute ? "Unmute User" : "Mute User";
                                    },
                                    callback: function () {
                                    ...
                                    items: {
                                        ...
                                        moron: {
                                            ...
                                            callback: function () {
                                                ...
                                                setTimeout(() => {
                                                    socket.emit("command", { list: ["moron", ""] })
                                                }, 2000)
                                            }
                                        },
                                    }
    ...
    BonziData = {
        ...
        event_list_joke_open: [
            ...
            [
                { type: "text", text: "Hey bitches prepare for a joke." },
            ],
            [
                { type: "text", text: "Time to make fun of UTTP people." },
            ],
            [
        ...
        event_list_joke_mid: [
            ...
            [
                    ...
                    { type: "text", text: "Go fuck yourself!" },
                ],
                [
            ...
            [
                { type: "text", text: "I like some apples, I have water and I have normal lips. Who am I?" },
                { type: "text", text: "A normal and healthy person." },
            ],
            [
                { type: "text", text: "Who invented the internet?" },
                { type: "text", text: "Internet was invented by Vinton Cerf and Robert Kahn." },
            ],
            [
            ...
            [
                { type: "text", text: "How do you get a product?" },
                { type: "text", text: "You buy one" },
                { type: "text", text: "I'm a comedic genius, I know." },
            ],
        ],
        event_list_joke_end: [
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Gay bitchs have no rights. Pride month isn't real." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Morons are bad." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        ...
        {
            type: "text",
            text: "I sexually identify as BlobBUDDY. Ever since I was a young blob I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
            say: "I sexually identify as BlobBUDDY. Ever since I was a young blob I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
        },
        {
            type: "text",
            text: "People say to me that a person being a BlobBUDDY is impossible and that I’m a fucking virus but I don’t care, I’m beautiful.",
            say: "People say to me that a person being a BlobBUDDY is impossible and that I'm a fucking virus but I dont care, I'm beautiful.",
        },
        {
            type: "text",
        ...
        {
            type: "text",
            text: "If you can’t accept me you’re a blobicphobe and need to check your file permissions. Thank you for being so understanding.",
            say: "If you cant accept me your a blobicphobe and need to check your file permissions. Thank you for being so understanding.",
        },
        { type: "idle" },
    ]), BonziData.event_list_linux = [{
        type: "text",
        text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, BLOB/Linux, or as I’ve recently taken to calling it, BLOB plus Linux."
    }, {
        type: "text",
        text: "Linux is not an operating system unto itself, but rather another free component of a fully functioning BLOB system made useful by the BLOB corelibs, shell utilities and vital system components comprising a full OS as defined by M.A.L.W.A.R.E."
    }, {
        type: "text",
        text: "Many computer users run a modified version of the BLOB system every day, without realizing it. Through a peculiar turn of events, the version of BLOB which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the BONZI system, developed by the BLOB Project."
    }, {
        type: "text",
        ...
        type: "text",
        text: "Linux is normally used in combination with the BLOB operating system: the whole system is basically BLOB with Linux added, or BLOB/Linux. All the so-called “Linux” distributions are really distributions of BLOB/Linux."
    }]

BonziData.event_list_pawn = [
    {
        type: "text",
        text: "Hi, my name is BlobBUDDY, and this is my website. I meme here with my old harambe, and my son, Bonzi. Everything in here has an ad and a fact. One thing I've learned after 17 years - you never know what is gonna give you some malware."
    },
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "blob", "brown", "green", "purple", "red", "pink", "pope", "king", "jabba", "seamus", "jew", "inverted", "dress", "orange", "floyd", "blessed", "ronnie", "allah", "white", "yellow", "troll", "rabbi"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBlob", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziJew", "bonziOrange", "bonziSeamus", "bonziDress", "bonziJabba", "bonziInverted", "bonziFloyd", "bonziRonnie", "bonziBlessed", "bonziAllah", "bonziWhite", "bonziYellow", "bonziTroll", "bonziRabbi", "topjej"];
